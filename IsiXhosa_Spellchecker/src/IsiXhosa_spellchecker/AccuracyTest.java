...
public class AccuracyTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            double correct = 0;
            double incorrect = 0;
            InputStream wdlist = IsiXhosa_Spellchecker.class
                    .getResourceAsStream("resources/XhosaAccuracyTestWords.txt");
            ...
            try {
                File unique = new File("uniqueX.txt");
                File corr = new File("correctX.txt");
                File incorr = new File("incorrectX.txt");
