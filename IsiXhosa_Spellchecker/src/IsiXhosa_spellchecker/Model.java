...
public class Model {
     ...
     */
    private boolean errorDetection(String in_word) {
        //Get trigrams of the word
        String word = ignorePunctuation(in_word);
     ...
     */
    private ArrayList<String> wordTrigram(String user_word) {

        ArrayList<String> strTri = new ArrayList<>();
        int pos = 0;
        String word = ignorePunctuation(user_word);
    ...
    private void initialize() {
        try {
            InputStream wdlist = IsiXhosa_Spellchecker.class.getResourceAsStream("resources/XhosaDictionary.txt");
            InputStream tri = IsiXhosa_Spellchecker.class.getResourceAsStream("resources/XhosaTrigrams.txt");
    ...
    /*Save the user dictionary to actual dictionary*/
